...
Minigame -> Rock, Paper, Scissors;win happiness & coins

Hunger -> +25 when feeding, -8 when playing minigame

Happiness -> increases with minigame, win = +20, tie = +10, lose = +5 & tap = +5, when happiness is high, you earn coins

Health -> +20 with heal button

Sleep -> random, can be waken up with heal button

Poop -> +2 coin when collected, +10 health

## Day time & weather 

Real day/night schedule with background changing
